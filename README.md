...
The following example will use a [vinyl-item](https://github.com/jonschlinkert/vinyl-item) constructor, which extends [vinyl](http://github.com/gulpjs/vinyl) with additional functionality.
